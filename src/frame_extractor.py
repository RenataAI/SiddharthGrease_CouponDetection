...
if __name__ == "__main__":
    ...
    VIDEO_PATH2 = "assets/input video/recording_20250903_164257.avi"

    OUTPUT_DIR_PATH = "dataset/raw_frames"
    OUTPUT_DIR_PATH2 = "dataset/raw_frames2"

    try:
        with VideoFrameExtractor(video_path=VIDEO_PATH2, output_dir=OUTPUT_DIR_PATH2) as extractor:
